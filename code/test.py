...
def main(args):
    ...
    for file_ in files:
        ...
        instance = read_pickle(file_fp)
        kps = instance["kps"]
        text = "It cannot be turned around this is the easy way out"
        pos = get_pos(text)
        ...
        Utils.visualize_data_single(faces_fake, "test_test3.mp4")
        import pdb
        pdb.set_trace()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_root', '-d', type = str, default = "/srv/storage/datasets/rafaelvieira/slp_dataset_f68_full_ps_new_arch_sample_wz_final_grammar/train")
    parser.add_argument('--outputs_root', '-ot', type = str, default = "/srv/storage/datasets/rafaelvieira/text2expression/results/")
    parser.add_argument('--decoder_ckpt', '-dckpt', type = str, default = "/srv/storage/datasets/rafaelvieira/text2expression/step_162500/decoder.pth")
    parser.add_argument('--zs_ckpt', '-zckpt', type = str, default = "/srv/storage/datasets/rafaelvieira/text2expression/step_162500/Zs.pkl")
    parser.add_argument('--zsent_ckpt', '-zsentckpt', type = str, default = "/srv/storage/datasets/rafaelvieira/text2expression/step_162500/Zsent.pkl")
