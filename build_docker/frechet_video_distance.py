...
def create_id3_embedding(videos, batch_size=16, module_spec="https://tfhub.dev/deepmind/i3d-kinetics-400/1"):
  ...
  # Making sure that we import the graph separately for each different input video tensor.
