...
class SignProdDataset(data.Dataset):                                                                                                                                                                        
    ...
    def __init__(self, dataset_root, train, fields, **kwargs):                                                   
        ...
        self.instance_names = sorted(os.listdir(self.dataset_root))[:551]
        idx = 0
        ...
        for instance_name in self.instance_names:
            ...
            #aus = instance["aus"]
            #pos = pad_pos(pos)
            examples.append(data.Example.fromlist([text, kps, sent_feature,sem_feature, None, None, z, idx, instance_name.replace(".pkl", "")], fields))
            idx += 1
