...
if __name__ == '__main__':
    ...
    input4 = torch.randn(257, 128)
    input0 = torch.randn(128, 128)
    input1 = torch.randn(32, 128)
    input2 = torch.randn(24, 128)
    input3 = torch.randn(17, 128)
